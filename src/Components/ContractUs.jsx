...
const ContractUs = () => {
  return (
    <div>
      ...
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-pink-100 transition">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-3xl w-full mx-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-gray-600">support@soulmate.com</span>
            </div>
            <div className="flex flex-col items-center">
